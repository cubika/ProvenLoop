...
**Version boundary (2026-09-06):** `0.1.0-alpha.0.8` is the Windows Design
...
[release notes](docs/releases/0.1.0-alpha.0.8.md) and
...
retaining an M0 blocker produces an explicit `No-Go`. The 0.8 aggregate
...
In `0.1.0-alpha.0.8`, inspect and maintain rules explicitly:
...
|---|---|
| Preview candidate | `0.1.0-alpha.0.8`, an evidence-collection prerelease, not M0/MVP approval |
...
not certify the versioned 0.8 artifacts; their validation and publication must
