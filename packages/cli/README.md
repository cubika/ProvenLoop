...
Windows Design Partner Preview `0.1.0-alpha.0.8` for ProvenLoop and GitHub
...
See the [0.8 release notes](https://github.com/cubika/ProvenLoop/blob/v0.1.0-alpha.0.8/docs/releases/0.1.0-alpha.0.8.md) for Knowledge
